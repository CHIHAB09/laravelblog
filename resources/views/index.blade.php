    ...
    <div class="sm:grid grid-cols-2 w-4/5 m-auto">
        <div class="flex bg-yellow-700 text-gray-100 pt-10">
            <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block">
                ...
                <h3 class="tect-xl font-bold py-10">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Harum, aperiam non, officia perspiciatis amet vel, deleniti et fuga omnis expedita nam veritatis? 
                    Eaque, quaerat molestiae? Ipsum voluptatum quia natus. Laudantium.
                </h3>
                <a 
                    href=""
                    class="uppercase bg-transparent border-2 border-gray-100 text-xs font-extrabold
